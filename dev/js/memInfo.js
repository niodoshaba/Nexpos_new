  ...
  function edit() {
    $(".edit").click(function () {
      ...
      tr.find("td:eq(0)").append(
        `<input class="CUS_LAST" value="${CUS_LAST}" type="text" size="3">`
      );
      // 名稱
      let CUS_FIRST = tr.find("td:eq(1)").text();
      tr.find("td:eq(1)").text("");
      tr.find("td:eq(1)").append(
        `<input class="CUS_FIRST" value="${CUS_FIRST}" type="text" size="5">`
      );
      //性別
      ...
      //狀態
      let CUS_STATE = tr.find("td:eq(8)").text();
      ...
      $(".save").click(function () {
        ...
        idPswUpdateData.CUS_ID = tr.find(".CUS_ID").val();
