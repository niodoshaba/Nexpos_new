window.addEventListener('load', function(){
  ...
  $('.addbtn').click(function(){
    ...
    $('.title').after(`
      <tr class="input">
        ...
        <td><input class="allDisEnd" type="date"></td>
  ...
  function edit(){
    $('.edit').click(function(){
      ...
      tr.find('td:eq(1)').append(`<input class="allDisName" value="${allDisName}" type="text" size="15">`);
      // 期間(起)
      ...
      tr.find('td:eq(3)').append(`<input class="allDisEnd" type="date">`);
      //折扣
      let allDiscount = tr.find('td:eq(5)').text();
      tr.find('td:eq(5)').text("");
      tr.find('td:eq(5)').append(`<input class="allDiscount" value="${allDiscount}" type="text" size="5">`)
      //編輯
