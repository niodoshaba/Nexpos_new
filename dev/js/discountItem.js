  ...
  window.addEventListener('load', function () {
    ...
    function showCheckBox() {
      $('.disItemCheck').click(function () {
        ...
        xhr.open("get", "./discountItemCheckShow.php", true);
        xhr.send(null);
      });
    }
    //按下選擇出現checkbox
    ...
    function showRowDisItem() {
      ...
      xhr.open("get", "./discountItemShow.php", true);
      xhr.send(null);
    }
    ...
    function showCheckedItem() {
      ...
      $('.show').click(function () {
        ...
        let xhr = new XMLHttpRequest();
        xhr.open("post", "./discountItemChecked.php", true);
    ...
    $('.addbtn').click(function () {
      ...
      $('.save').click(function () {
        ...
        //設定文件格式
        xhr.open("post", "discountItemInsert.php", true);
        xhr.setRequestHeader("content-type", "application/x-www-form-urlencoded");
        //將要傳送的物件資料轉為字串型別
    ...
    function edit() {
      $('.edit').click(function () {
        ...
        $('.save').click(function () {
          ...
          // 設定文件格式
          xhr.open("post", "discountItemUpdate.php", true);
          xhr.setRequestHeader("content-type", "application/x-www-form-urlencoded");
          //將要傳送的物件資料轉為字串型別
